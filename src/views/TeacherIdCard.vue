...
const fetchTeacher = async () => {
  try {
    ...
    // ডাটা সেট করা (প্রোফাইল থেকে ইমেজ ফুল পাথ চেক করা)
      ...
      <div class="id-card">
        ...
        <div class="photo-section">
          <div class="photo-frame">
            <img :src="teacher.image" class="teacher-img" alt="Teacher" />
          </div>
        ...
        <div class="details-box">
          <div class="info-row">
            ...
            <span class="value highlight">#TCH-{{ teacher.id }}</span>
          </div>
          <div class="info-row">
          ...
          <div class="info-row">
            ...
            <span class="value blood">{{ teacher.blood_group }}</span>
          </div>
          <div class="info-row">
            <span class="label">Joined :</span>
            <span class="value">{{ teacher.joining_date }}</span>
          </div>
        </div>
